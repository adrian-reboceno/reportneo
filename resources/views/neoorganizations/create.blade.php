...
@section('title', 'Neo organizations create')
...
@section('content')
<form method="POST" action="{{ route('neoorganizations.store') }}" >
    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="lms_organization" name="lms_organization" placeholder="Enter LMS Organization" value="{{old('lms_organization') }}">
                        ...
                        <div class="col-lg-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="name_organization" name="name_organization" placeholder="Enter Name organization" value="{{old('name_organization') }}">
