...
@section('title', ' Neo organizations list')
            ...
            <div class="card-body">
                <div class="row align-items-center m-l-0">
                    ...
                    <div class="col-sm-6 text-right">
                        @can('neoorganization-create')  
                            <a class="btn btn-success btn-sm mb-3 btn-round" href="{{route('neoorganizations.create')}}"><i class="feather icon-plus"></i> Add Neo Organization</a>
                        @endcan
                    </div>
                </div>
                <div >
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu">
                                            @can('neoorganization-show')  
                                                <li><a href="{{ route('neoorganizations.show', $neoOrganization->id)}}" class="dropdown-item"><i class="bi bi-eye-fill align-bottom me-2 text-muted"></i> View</a></li>
                                            @endcan
                                            @can('neoorganization-edit')  
                                                <li><a href="{{ route('neoorganizations.edit', $neoOrganization->id)}}" class="dropdown-item edit-item-btn"><i class="bi bi-pencil-fill align-bottom me-2 text-muted"></i> Edit</a></li>
                                            @endcan
                                            @can('neoorganization-delete')  
                                                <li>                                               
                                                    <form action="{{ route('neoorganizations.destroy', $neoOrganization->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
